...
```
cd existing_repo
git remote add origin https://coursegit.cs.lth.se/edaf45/ht25-vt26/projects/team04.git
git branch -M main
...
* [Set up project integrations](https://coursegit.cs.lth.se/edaf45/ht25-vt26/projects/team04/-/settings/integrations)
