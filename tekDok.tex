...
Vänligen notera att det praktiseras \textbf{Test Driven Development} och förutsätts att man följer det för de delar listad nedan. Detta medför även att refaktorisering ska göras kontinuerligt för att bibehålla kodkvalitet och tydlig struktur.
All ny funktionalitet ska först specificeras genom tester innan implementation påbörjas.
Tester placeras i \texttt{tests/}-mappen och ska täcka både lyckade och felaktiga scenarion.
...
\begin{enumerate}
    \item Uppdatera arkitekturdiagram vid större förändringar.
