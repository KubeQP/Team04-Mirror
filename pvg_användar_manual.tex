...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{Screenshots till användarmanual/Dark mode.png}
  \caption{Dark mode}
  \label{fig:Dark mode}
\end{figure}
...
Innehåller ett inmatningsfält och en registreringsknapp där man kan registrera stationer genom att skriva in stationsnamn och trycka på knappen. 
Stationen kommer automatiskt komma sist i ordningen men det kan ändras i tabellen nedan.
Under formuläret visas en tabell med de registrerade stationerna. 
På varje stationsrad finns pilar där man kan ändra ordning på stationerna och även en radera-funktion som tar bort stationen. 

\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{Screenshots till användarmanual/stationshantering.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{Screenshots till användarmanual/Registrera.png}
  \caption{Registreringssida}
  \label{fig:Registreringssida}
\end{figure}

\subsection{Resultatvisare}
Innehåller en resultatvisare som har en lista på alla tävlande med rang, startnummer, namn, stationstid och totaltid, sorterad på totaltid. 
Under varje stationstid står det differansen till förra stationen. 
För att förare ska visas upp krävs det att de har en starttid.
De kommer även inte visas upp om de har mer än två tider på samma station eller om det finns en tidigare tidpunkt på en senare station.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{Screenshots till användarmanual/PlaceHolder.png}
  \caption{Startsida med resultatvisare}
  \label{fig:PlaceHolderAppName}
\end{figure}

\subsection{Tidsregistrering}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{Screenshots till användarmanual/Stopptid.png}
  \caption{Stopptidsregistrering}
  \label{fig:Stopptidsregistrering}
\end{figure}

\subsection{Admin}
En kontinuerligt uppdaterad vy som visar registrerade tävlande med startnummer, namn, tidpunkter på varje station och total tid.

Här presenteras all information om de tävlande i två tabeller:
\begin{itemize}
  \item Station, startnummer och tid
  \item Startnummer, namn, tidpunkter för varje station och totalt resultat (sorterad på startnummer)
\end{itemize}

Röda rutor indikerar felaktig registrering.
Till exempel om det är två eller fler tider på samma station.
Då ser man även alla tiderna.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.7\textwidth]{Screenshots till användarmanual/Admin.png}
  \caption{Admin-sida}
  \label{fig:Admin}
\end{figure}
